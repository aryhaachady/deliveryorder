...
<section class="section dashboard">
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">History Reservations</h5>
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#reservationModalEdit{{ $reservation->id }}">Edit</button>
                                    <button class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#reservationModalDelete{{ $reservation->id }}">Delete</button>
